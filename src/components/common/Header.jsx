          ...
          <div className="flex justify-between items-center h-10">
            <div className="hidden md:flex items-center space-x-6">
              <div className="flex gap-2 items-center">
                <img src="/images/img_call.svg" alt="Phone" className="w-4 h-4" />
              ...
              <div className="flex gap-2 items-center">
                <img src="/images/img_mail.svg" alt="Email" className="w-4 h-3" />
                <span className="text-xs font-medium text-[#f9f9f9] font-['Archivo']">
                  comercial@rsfitnes.com.br
                </span>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-center ml-auto">
              <Link
                href="http://www.clubti.com.br/webmail"
                className="block"
                target="_blank"
              ...
              <Link href="https://www.instagram.com/ronnycoach30/" className="block">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
          ...
          <div className="flex justify-between items-center py-3">
            ...
            <div className="flex-shrink-0">
              <div className="text-3xl font-bold font-['Oswald']">
                <span className="text-[#ff6600]">RS</span>{' '}
